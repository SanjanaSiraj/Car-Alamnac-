...
import Utils.Car;
import Utils.EditCarInDatabase;
...
public class EditCarController {
    ...
    public void Save(ActionEvent actionEvent) {
        EditCarInDatabase ecid = new EditCarInDatabase();
        ecid.setRegNum(regNum.getText());
        ecid.setProperty(property.getText());
        ecid.setNewValue(newValue.getText());
        try {
